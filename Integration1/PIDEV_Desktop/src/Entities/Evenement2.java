...
public class Evenement2 {
    ...
    public Evenement2(float prix_even, String desc_even, String titre_even, int nbre_place, String date_debut, String date_fin) {
        this.prix_even = prix_even;
        this.desc_even = desc_even;
        this.titre_even = titre_even;
        this.nbre_place = nbre_place;
    ...
    public Evenement2(int id, float prix_even, String desc_even, String titre_even, int nbre_place, String date_debut, String date_fin) {
        this.id = id;
        this.prix_even = prix_even;
        this.desc_even = desc_even;
        this.titre_even = titre_even;
